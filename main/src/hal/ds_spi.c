...
//To speed up transfer, every SPI transfer sends a bunch of lines. This define specifies how many. More means more memory use,
//but less overhead for setting up / finishing transfers. Make sure 240 is dividable by this.
#define PARALLEL_LINE 16
...
void screen_spi_init(void){
    ...
    spi_bus_config_t buscfg = {
        .miso_io_num = PIN_NUM_MISO,                // MISO Signal
        .mosi_io_num = PIN_NUM_MOSI,                // MOSI Signal
        .sclk_io_num = PIN_NUM_CLK,                 // SCLK Signal
        .quadwp_io_num = -1,                        // WP Signal，QSPI-D2
        .quadhd_io_num = -1,                        // HD Signal，QSPI-D3
        .max_transfer_sz = 64*8,                    // MAX Data trans size
    };
