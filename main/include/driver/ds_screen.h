...
void ds_screen_partial_dispaly(unsigned int x_start, unsigned x_end, unsigned y_start, unsigned y_end,
                                void partial_old(void),
                                void partial_new(void));
void ds_screen_partial_display_bydata(unsigned int x_start, unsigned int x_end, unsigned int y_start, unsigned y_end,
...
void ds_scrren_full_display_bydata(void display_func(const uint8_t *data), const uint8_t *data);
...
void ds_screen_parital_data_copy();
#endif
